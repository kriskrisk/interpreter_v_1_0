...
instance Print (ArgT a) where
  prt i e = case e of
    ...
    RefArgT _ type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
...
instance Print (Expr a) where
  prt i e = case e of
    ...
    Neg _ expr -> prPrec i 6 (concatD [doc (showString "-"), prt 6 expr])
    Not _ expr -> prPrec i 6 (concatD [doc (showString "!"), prt 6 expr])
    Anon _ type_ args block -> prPrec i 5 (concatD [doc (showString "!"), prt 0 type_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
